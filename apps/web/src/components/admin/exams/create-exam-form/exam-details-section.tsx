		...
		<Card className="border-0 bg-gradient-to-br from-background to-muted/30 shadow-lg">
			<CardHeader className="pb-6">
				<div className="flex items-center gap-4">
					...
					<div>
						<CardTitle className="font-bold text-2xl">Exam Details</CardTitle>
			...
			<CardContent className="space-y-8">
				...
				<div className="pt-3">
					...
					{totalQuestions === 0 && (
						<p className="mt-2 text-center text-muted-foreground text-sm">
							Add at least one question to create the exam
						</p>
					)}
				</div>
				...
				<Separator />
				<div>
					<Label className="mb-3 font-medium text-sm">Question Stats</Label>
